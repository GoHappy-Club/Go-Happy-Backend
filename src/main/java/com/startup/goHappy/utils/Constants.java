...
public class Constants {
    ...
    public String getJoiningContent() {
        return EventContent;
    }
    ...
    String EventContent = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n"
...
//			+ "</table>\n"
    ...
    String joiningContent = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n"
            + "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\">\n"
            + "<head>\n"
            + "<!--[if gte mso 9]>\n"
            + "<xml>\n"
...
//			+ "</table>\n"
            ...
            + "    <p style=\"line-height: 130%; font-size: 14px;\"><span style=\"font-size: 16px; line-height: 20.8px;\"><strong>${name}</strong></span></p>\n"
            + "<p style=\"font-size: 14px; line-height: 130%;\">&nbsp;</p>\n"
            + "<p style=\"font-size: 14px; line-height: 130%;\"><span style=\"font-size: 16px; line-height: 20.8px; font-family: Lato, sans-serif;\">Thank you for Joining GoHappy Club Family,&nbsp;.</span></p>\n"
            + "  </div>\n"
            + "\n"
            + "      </td>\n"
            + "    </tr>\n"
